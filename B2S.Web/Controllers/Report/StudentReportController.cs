...
namespace B2S.Web.Controllers
{
    public class StudentReportController : Controller
    {
        ...
        public StudentReportController(AppDbContext context, IOptions<PaginationOptions> options)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index(string search, DateTime? currentFrom, DateTime? currentTo, int? page)
        {
            ...
            var bookings = _context.Booking.Where(b => b.BookingFrom <= currentTo && b.BookingTo >= currentFrom).Include(b => b.Bed.Room.RoomType).Include(b => b.Bed.Room.Building.Property).Select(b => b);           
